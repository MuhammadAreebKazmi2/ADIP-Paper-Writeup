...
\begin{figure}[ht]
    ...
    \hfill
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\linewidth]{fig1a_ans.PNG} % Replace 'image2' with your actual filename
        \caption{Figure 1a.2: Impact on the real image}
        \label{fig:subfig2}
    \end{subfigure}
	\hfill
	\begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\linewidth]{fig1b.PNG} % Replace 'image1' with your actual filename
        \caption{Figure 1b.1: For 3 number of clusters}
        \label{fig:subfig3}
    \end{subfigure}
	\hfill
	\begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\linewidth]{fig1b_ans.PNG} % Replace 'image1' with your actual filename
...
\begin{figure}[ht]
    \centering
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\linewidth]{fig2a.jpg} % Replace 'image1' with your actual filename
        \caption{Deforested area}
        \label{fig:subfig1}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\linewidth]{fig2red.jpeg} % Replace 'image2' with your actual filename
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\linewidth, height=6cm]{Figure 3.jpg} % Replace 'your_image_filename' with the actual filename of your image
...
\begin{figure}[ht]
    ...
    \begin{subfigure}{0.40\textwidth}
        \includegraphics[width=\linewidth, height=4.5cm]{ex1_cluster.PNG} % Replace 'image1' with your actual filename
        % \caption{Caption for Figure 1a}
        \label{fig:subfig1}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.40\textwidth}
        \includegraphics[width=\linewidth, height=4.5cm]{ex1_NDVI.PNG} % Replace 'image2' with your actual filename
        % \caption{Amount of vegetation detected}
        \label{fig:subfig2}
    \end{subfigure}
	\hfill
    \begin{subfigure}{0.40\textwidth}
        \includegraphics[width=\linewidth, height=4.5cm]{ex1_sat.PNG} % Replace 'image2' with your actual filename
        %  \caption{Amount of vegetation detected}
        \label{fig:subfig2}
    \end{subfigure}
	\hfill
    \begin{subfigure}{0.40\textwidth}
        \includegraphics[width=\linewidth, height=4.5cm]{example1.PNG} % Replace 'image2' with your actual filename
        % \caption{Amount of vegetation detected}
        \label{fig:subfig2}
    \end{subfigure}
